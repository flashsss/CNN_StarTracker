...
#CONVOLUTION 1
cnn.add(tf.keras.layers.Conv2D(filters=96,kernel_size=11,activation='relu',input_shape=[227,227,3]))
#POOLING 1
cnn.add(tf.keras.layers.MaxPool2D(pool_size=3,strides=2))
#CONVOLUTION 2
cnn.add(tf.keras.layers.Conv2D(filters=256,kernel_size=5,activation='relu'))
#POOLING 2
cnn.add(tf.keras.layers.MaxPool2D(pool_size=3,strides=2))
#CONVOLUTION 3
cnn.add(tf.keras.layers.Conv2D(filters=384,kernel_size=3,activation='relu'))
#CONVOLUTION 4
cnn.add(tf.keras.layers.Conv2D(filters=384,kernel_size=3,activation='relu'))
#CONVOLUTION 5
